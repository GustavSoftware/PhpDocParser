...
/**
 * This class represents a see-tag.
 *
 * @author Chris Köcher <ckone@fieselschweif.de>
 * @link   https://gustav.fieselschweif.de
 * @since  1.0.0
 */
class SeeTag extends ATag
{
    /**
     * The referenced URI or name of a structural element.
     *
     * @var string
     */
    ...
    /**
     * Returns the referenced URI or name of a structural element.
     *
     * @return string
     *   The URI or structural element
     */
