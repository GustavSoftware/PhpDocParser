...
/**
 * This class represents all the data of some function (which is not related to any class).
 *
 * @author Chris Köcher <ckone@fieselschweif.de>
 * @link   https://gustav.fieselschweif.de
 * @since  1.0.0
 */
class FunctionData extends AFunctionData
{
    /**
     * The reflection.
     *
     ...
     */
    private ReflectionFunction $_reflection;
