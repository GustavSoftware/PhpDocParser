...
/**
 * This class represents all the data of some class constant.
 *
 * @author Chris Köcher <ckone@fieselschweif.de>
 * @link   https://gustav.fieselschweif.de
 * @since  1.0.0
 */
class ConstantData extends AData
{
    /**
     ...
     */
    private ReflectionClassConstant $_reflection;
    ...
    public function __construct(
        ReflectionClassConstant $reflection, ?VarTag $var = null, string $description = "", array $inlineTags = [],
